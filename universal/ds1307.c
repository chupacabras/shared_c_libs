 ...
 * @param  handle:       Pointer to a DS1307_Handle structure that contains
 ...
 */
void DS1307_init(DS1307_Handle * handle, device_write_ptr write_cmd, device_read_ptr read_cmd) {
 ...
 */
void DS1307_write_ram(DS1307_Handle *handle, uint8_t offset, uint8_t data) {
	handle->write_cmd(handle, DS1307_RAM_START + offset, &data, 1);
}
 ...
 */
uint8_t DS1307_read_ram(DS1307_Handle *handle, uint8_t offset) {
	handle->read_cmd(handle, DS1307_RAM_START + offset, &temp, 1);
	return temp;
}
 ...
 */
void DS1307_write_ram_burst(DS1307_Handle *handle, uint8_t *buf, uint8_t len) {
	handle->write_cmd(handle, DS1307_RAM_START, buf, len);
}
 ...
 */
void DS1307_read_ram_burst(DS1307_Handle *handle, uint8_t *buf, uint8_t len) {
	handle->read_cmd(handle, DS1307_RAM_START, buf, len);
}
...
// */
//void DS1307_get_seconds(DS1307_Handle *handle, RTC_time * time) {
//	handle->read_cmd(handle, DS1307_REG_SEC, &temp, 1);
...
// * @param  time:      Pointer to a RTC_time structure that contains time values.
// */
//void DS1307_get_minutes(DS1307_Handle *handle, RTC_time *time) {
//	handle->read_cmd(handle, DS1307_REG_MIN, &temp, 1);
...
// * @param  time:      Pointer to a RTC_time structure that contains time values.
// */
//void DS1307_get_hours(DS1307_Handle *handle, RTC_time *time) {
//	handle->read_cmd(handle, DS1307_REG_HOUR, &temp, 1);
...
// * @param  time:      Pointer to a RTC_time structure that contains time values.
// */
//void DS1307_get_day_of_week(DS1307_Handle *handle, RTC_time *time) {
//	handle->read_cmd(handle, DS1307_REG_DAY, &temp, 1);
...
// * @param  time:      Pointer to a RTC_time structure that contains time values.
// */
//void DS1307_get_date(DS1307_Handle *handle, RTC_time *time) {
//	handle->read_cmd(handle, DS1307_REG_DATE, &temp, 1);
...
// * @param  time:      Pointer to a RTC_time structure that contains time values.
// */
//void DS1307_get_month(DS1307_Handle *handle, RTC_time *time) {
//	handle->read_cmd(handle, DS1307_REG_MONTH, &temp, 1);
...
// * @param  time:      Pointer to a RTC_time structure that contains time values.
// */
//void DS1307_get_year(DS1307_Handle *handle, RTC_time *time) {
//	handle->read_cmd(handle, DS1307_REG_YEAR, &temp, 1);
 ...
 * @param  time:      Pointer to a RTC_time structure that contains time values.
 */
void DS1307_read_time(DS1307_Handle *handle, RTC_time *time) {
	handle->read_cmd(handle, DS1307_REG_SEC, temp_arr, 7);
 ...
 * @param  time:      Pointer to a RTC_time structure that contains time values.
 */
void DS1307_write_time(DS1307_Handle *handle, RTC_time *time) {
	...
	handle->write_cmd(handle, DS1307_REG_SEC, temp_arr, 7);
}
...
// * @param  val:      Seconds.
// */
//void DS1307_set_seconds(DS1307_Handle *handle, uint8_t val) {
//	temp=num_to_bcd(val & 0x7f);
//	handle->write_cmd(handle, DS1307_REG_SEC, &temp, 1);
//}
//
///**
...
// * @param  val:      Minutes.
// */
//void DS1307_set_minutes(DS1307_Handle *handle, uint8_t val) {
//	temp=num_to_bcd(val & 0x7f);
//	handle->write_cmd(handle, DS1307_REG_MIN, &temp, 1);
//}
//
///**
...
// */
//void DS1307_set_hours(DS1307_Handle *handle, uint8_t val, RTCHoursFormat hour_format) {
//	temp=rtc_encode_hours(val, hour_format);
//
//	handle->write_cmd(handle, DS1307_REG_HOUR, &temp, 1);
//}
//
/**
 ...
 */
void DS1307_set_day_of_week(DS1307_Handle *handle, RTCDay val) {
	temp=val & 0x07;
	handle->write_cmd(handle, DS1307_REG_DAY, &temp, 1);
}
//
///**
...
// */
//void DS1307_set_date(DS1307_Handle *handle, uint8_t val) {
//	temp=num_to_bcd(val & 0x3f);
//	handle->write_cmd(handle, DS1307_REG_DATE, &temp, 1);
//}
//
///**
...
// * @param  val:      Month.
// */
//void DS1307_set_month(DS1307_Handle *handle, uint8_t val) {
//	temp=num_to_bcd(val & 0x1f);
//	handle->write_cmd(handle, DS1307_REG_MONTH, &temp, 1);
//}
//
///**
...
// */
//void DS1307_set_year(DS1307_Handle *handle, uint8_t val) {
//	temp=num_to_bcd(val);
//	handle->write_cmd(handle, DS1307_REG_YEAR, &temp, 1);
//}
 ...
 */
bool DS1307_clock_halted(DS1307_Handle *handle) {
	handle->read_cmd(handle, DS1307_REG_SEC, &temp, 1);
	return ((temp & 0x80) != 0);
}
 ...
 *                    the information for the display.
 */
void DS1307_clock_halt(DS1307_Handle *handle) {
	handle->read_cmd(handle, DS1307_REG_SEC, &temp, 1);
	temp = temp | 0x80;
	handle->write_cmd(handle, DS1307_REG_SEC, &temp, 1);
}
 ...
 *                    the information for the display.
 */
void DS1307_clock_start(DS1307_Handle *handle) {
	handle->read_cmd(handle, DS1307_REG_SEC, &temp, 1);
	temp = temp & 0x7f;
	handle->write_cmd(handle, DS1307_REG_SEC, &temp, 1);
}
 ...
 */
void DS1307_set_output_control(DS1307_Handle *handle, DS1307_OutputControl output) {
	handle->write_cmd(handle, DS1307_REG_CONTROL, (uint8_t *)&output, 1);
}
 ...
 */
DS1307_OutputControl DS1307_get_output_control(DS1307_Handle *handle) {
	handle->read_cmd(handle, DS1307_REG_CONTROL, &temp, 1);
	return temp;
}
