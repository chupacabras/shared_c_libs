 ...
 * @param  handle:       Pointer to a PCF8563_Handle structure that contains
...
void PCF8563_read_time(PCF8563_Handle *handle, RTC_time * time) {
	handle->read_cmd(handle, PCF8563_REG_SECONDS, temp_arr, 7);
...
void PCF8563_write_time(PCF8563_Handle *handle, RTC_time * time) {
	...
	handle->write_cmd(handle, PCF8563_REG_SECONDS, temp_arr, 7);
}
...
PCF8563_ControlStatus1 PCF8563_get_control_status1(PCF8563_Handle *handle) {
	handle->read_cmd(handle, PCF8563_REG_CONTROL_STATUS_1, &temp, 1);
...
PCF8563_ControlStatus2 PCF8563_get_control_status2(PCF8563_Handle *handle) {
	handle->read_cmd(handle, PCF8563_REG_CONTROL_STATUS_2, &temp, 1);
...
PCF8563_CLKOUT_Control PCF8563_get_clkout_control(PCF8563_Handle *handle) {
	handle->read_cmd(handle, PCF8563_REG_CLKOUT_CONTROL, &temp, 1);
...
void PCF8563_read_alarm(PCF8563_Handle *handle, PCF8563_Alarm * alarm) {
	handle->read_cmd(handle, PCF8563_REG_ALARM_MINUTE, alarm->DATA, 4);
}
...
void PCF8563_set_alarm(PCF8563_Handle *handle, uint8_t date, uint8_t weekday, uint8_t hours, uint8_t minutes, uint8_t alarm_flags) {
	...
	handle->write_cmd(handle, PCF8563_REG_ALARM_MINUTE, temp_arr, 4);

	// enable alarm interrupt
	handle->read_cmd(handle, PCF8563_REG_CONTROL_STATUS_2, &temp, 1);
	((PCF8563_ControlStatus2*)&temp)->AIE=1;
	handle->write_cmd(handle, PCF8563_REG_CONTROL_STATUS_2, &temp, 1);
}
...
void PCF8563_set_timer(PCF8563_Handle *handle, uint8_t timer, PCF8563_TimerSource clock_source) {
	handle->write_cmd(handle, PCF8563_REG_TIMER, &timer, 1);

	temp=0;
	((PCF8563_Timer_Control*)&temp)->TD=clock_source;
	((PCF8563_Timer_Control*)&temp)->TE=1;

	handle->write_cmd(handle, PCF8563_REG_TIMER_CONTROL, &temp, 1);
}
...
void DS3231_disable_timer(PCF8563_Handle *handle) {
	handle->read_cmd(handle, PCF8563_REG_TIMER_CONTROL, &temp, 1);
...
bool DS3231_clock_integrity_guaranteed(PCF8563_Handle *handle) {
	handle->read_cmd(handle, PCF8563_REG_SECONDS, &temp, 1);
	return (temp & 0x80)==0;
}
